...
>
  ...
  <div class="top-50 flex flex-col items-center mt-20">
    <!-- Home -->
    <a
      class="flex items-center justify-center w-12 h-12 mt-2 rounded-full hover:bg-white hover:bg-opacity-5 hover:text-gray-300"
      href="#"
    >
      <svg
    ...
    >
      ...
      >
        <g id="surface6550042">
          <path
            style=" stroke:none;fill-rule:nonzero;fill:rgb(93.333334%,93.333334%,93.333334%);fill-opacity:1;"
            d="M 16.191406 21 L 7.546875 21 L 0 12.375 L 0 2.320312 Z M 8.453125 19 L 11.808594 19 L 2 7.679688 L 2 11.625 Z M 21.535156 16 L 13.953125 16 L 24 3.085938 L 24 12.300781 Z M 18.042969 14 L 20.464844 14 L 22 11.695312 L 22 8.914062 Z M 18.042969 14 "
          />
        </g>
      </svg>
    </a>
